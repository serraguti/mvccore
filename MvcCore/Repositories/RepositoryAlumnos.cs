...
namespace MvcCore.Repositories
{
 ...
 , Nota = int.Parse(datos.Element("nota").Value)
        ...
        {
            //CUANDO HABLAMOS DE CONSULTAS DE ACCION SOBRE XML
            //TENEMOS QUE PENSAR QUE DEBEMOS ACCEDER A ETIQUETAS, NO 
            //A OBJETOS Alumno
            var consulta = from datos in this.docxml.Descendants("alumno")
        ...
        public void InsertarAlumno(int idalumno, String nombre, String apellidos
            , int nota)
        {
            /*
              <alumno>
            ...
            */
            ...
            //EL XMLELEMENT DEBEMOS AGREGARLO AL DOCUMENTO Y EN LA ETIQUETA QUE
            //CORRESPONDA 
            this.docxml.Element("alumnos").Add(elementalumno);
            this.docxml.Save(this.path);
        }

        public void ModificarAlumno(int idalumno, String nombre, String apellidos
            , int nota) {
